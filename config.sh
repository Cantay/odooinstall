...
PROJECT_NAME="likittelekom"  #Proje adını giriniz
WEBSITE_NAME="www.likittelekom.net" #We
...
EMAIL="info@likittelekom.net"
CRON_SCRIPT="/etc/cron.daily/certbot-renew"

PUBLIC_IP="193.42.103.16" #MANUEL OLARAK AYARLA
DOMAIN_NAME="likittelekom.net" # DNS YAPILANDIRILMASI YAPILMALIDIR!
DOMAIN_ALIASES=("www.likittelekom.net") # ("www.autoronics.com")
...
INSTALL_PG_SERVER="False" # false ise, yalnızca istemci kurulacaktır
